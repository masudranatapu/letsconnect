            ...
            <div class="page-header d-print-none">
                <div class="row align-items-center">
                    <div class="col">
                     ...
                     @if ($settings->application_type == 'VCARD')
                    ...
                    @if ($settings->application_type == 'STORE')
                        <div class="col-auto ms-auto d-print-none">
                            <div class="d-flex">
                    ...
                    @if ($settings->application_type == 'BOTH')
                    <!-- Page title actions -->
                        <div class="col-auto ms-auto d-print-none">
                            <div class="dropdown">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-list flex-nowrap">
                                                        ...
                                                        @if($business_card->theme_id == '7ccc432a06caa')
                                                            <a class="btn btn-primary btn-sm"
                                                               href="{{ route('user.modern-card.edit', $business_card->card_id)}}">{{ __('Edit') }}</a>
                                                        @else
                                                            <a class="btn btn-primary btn-sm"
