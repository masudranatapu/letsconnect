                                ...
                                <h3 class="card-title text-danger">{{ __('Payment method') }}</h3>
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <div class="col-12">
                                                <input type="submit" id="continuePaypalBtn" value="{{ __('Continue for payment') }}"
                                                    class="btn btn-primary">

                                                <a type="button" class="open-plan-model btn btn-primary" id="continueStripeBtn"
                                                   href="#openStripeModel">{{ __('Continue for payment') }}</a>
...
@endif
@include('user.checkout._partial-pay-with-stripe')
...
@push('custom-js')
    <script>
        $(document).ready(function(){
            $('#continueStripeBtn').hide();
            $('input[type=radio][name=payment_gateway_id]').change(function() {
                //paypal
                if (this.value == "60964401751ab") {
                    $('#continuePaypalBtn').show();
                    $('#continueStripeBtn').hide();
                    $('#continuePaypalBtn').attr('type','submit');


                }else if (this.value == "60964410732t9") {
                    $('#continuePaypalBtn').hide();
                    $('#continuePaypalBtn').attr('type','button');
                    $('#continueStripeBtn').show();
                    $('#stripePaymentGateway').val(this.value)
