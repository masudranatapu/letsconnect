...
<head>
    ...
    <style>
        ...
        .footer_sec {background: #151313;padding: 14px 1px;color: #fff !important;}
...
<body class="antialiased bg-black text-body font-body"
    ...
    <div class="">
                ...
                <div class="flex flex-wrap -m-4">
                    ...
                    <div class="w-1/2 lg:w-1/3 p-4">
                        <div class="p-4 bg-white shadow-lg rounded-lg">
                            ...
                            <span class="py-1 px-2 bg-red-500 product_badge rounded text-xs text-white">{{
                                    $product->badge }}</span>
                            <div class="w-full mb-1 mt-1 justify-between items-center">
                                <div>
                                    <h3 id="{{ $product->product_id }}_product_name" class="text-sm font-medium text-dark product_title">
                                        {{ $product->product_name }}</h3>
                                    <span id="{{ $product->product_id }}_subtitle" class="text-xs text-dark product_info">{{
                                        $product->product_subtitle }}</span>
                                </div>
                            </div>
                            <div class="w-full mb-1 justify-between items-center">
                                <h4 class="text-sm mb-3 font-bold text-dark product_price"><span id="{{ $product->product_id }}_currency">{{
        ...
        <div class="py-8">
            ...
            <div class="w-auto ml-6 pb-3 pt-3 social_media">
