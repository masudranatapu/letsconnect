...
<head>
    ...
    <style>
        ...
        .card_banner .custom-shape-divider-bottom-1647167483 {
            position: absolute;
            bottom: 0;
            left: 0;
            width: 100%;
        ...
        .card_banner .custom-shape-divider-bottom-1647167483 svg {
            position: relative;
            display: block;
        ...
        .card_banner .custom-shape-divider-bottom-1647167483 .shape-fill {
            fill: #FFFFFF;
        }
        img.profile {
            position: relative;
            ...
            <div id="profile"
                ...
                <div class="max-w-xl w-full mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
                    <div class="card_banner">
                        ...
                        <div class="custom-shape-divider-bottom-1647167483">
                    ...
                    <ul class="grid grid-flow-col grid-cols-1 grid-rows-1">
                        ...
                        <li>
                            <div class="flex items-center w-full px-5 ">
                                <div
                                    class="flex justify-center items-center content-center bg-gradient-to-br from-{{ $business_card_details->theme_color }}-300 to-{{ $business_card_details->theme_color }}-800 shadow-md hover:shadow-lg h-12 w-12 rounded-lg fill-current text-white">
                    ...
                    <div class="w-full border-t align-middle border-b section_title">
                            ...
                            <div class="container mx-auto">
                                <div class="flex flex-wrap">
                                        ...
                                        <div class="lg:w-1/2">
                                            <div class="m-2">
                                                <div class="w-full overflow-hidden rounded-lg shadow-lg">
                                                    <a href="{{ $galleries_detail->gallery_image }}" data-toggle="lightbox" data-gallery="gallery" class="col-md-6">
                                                        <img class="w-full"
                    ...
                    @if ($business_hours != null && $business_hours->is_display != 0)
                        ...
                        <div class="px-5 py-4 business_house_list">
                    ...
                    <div id="share" class="w-full border-t align-middle border-b section_title">
                    ...
                    <div class="pb-1">
                        <div class="pb-5 px-3 pt-5 font-semibold text-dark text-sm">
                            <div class="mt-2">
                                {{ __('Copyright') }} &copy;
                    ...
                    <div class="pb-1">
                        <div
                            class="pb-5 text-center px-3 m-auto pt-5 font-semibold border-t text-gray-800 text-sm">
                            <div class="mt-2">
                                {{ __('Made with') }}
                                <a class="text-{{ $business_card_details->theme_color }}-800"
